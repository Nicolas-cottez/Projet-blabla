    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form id="searchForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" id="date" name="date" class="search-inputmb 4 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
