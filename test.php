						...
						<div class="card-3d-wrap mx-auto">
							<div class="card-3d-wrapper">
								<div class="card-front">
									<div class="center-wrap">
										<div class="section text-center">
											<h4 class="mb-6 pb-4 font-medium text-3xl">Log In</h4>
								...
								<div class="card-back">
									<div class="center-wrap">
										<div class="section text-center">
											<h4 class="mb-3 pb-3 font-medium text-3xl">Sign Up</h4>
											<div class="form-group">
											...
											<div class="form-group mt-2">
												<input type="file" class="form-style" placeholder="Upload Photo">
